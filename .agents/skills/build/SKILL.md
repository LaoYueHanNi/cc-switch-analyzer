---
name: build
description: 在 Windows / macOS 上构建 Tauri 桌面应用，支持 --no-bundle 快速调试打包、TrafficMonitor 32 位 DLL 插件编译、前后端独立构建命令。
whenToUse: 用户提及打包 / 构建 / build / 编译应用 / 出二进制 / 编译 TrafficMonitor 插件
---
